...
namespace SMSystem.Gui.Reports
{
    public partial class ReceiptUserControl : Form
    {
        ...
        public ReceiptUserControl(int OutComeMaterialId)
        {
            ...
            TextBoxReciveDate.Text = DateTime.Now.ToShortDateString();
        ...
        private void SetDataGridViewColumns()
        {
            try
            {
                ...
                dataGridView.Columns[3].HeaderCell.Value = "السعر";
                dataGridView.Columns[4].HeaderCell.Value = "الاجمالى ج.م";
        ...
        private void dataGridView_CellValueChanged(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {
                txttotalbill.Text = Convert.ToString(double.Parse(txttotalbill.Text) + double.Parse(dataGridView.Rows[i].Cells[4].Value.ToString()));
            }
        }
    }
}
