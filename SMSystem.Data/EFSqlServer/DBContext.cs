...
namespace SMSystem.Data.EF
{
    public class DBContext : DbContext
    {
        ...
        {
            var DevelopmentConString = @"Server=.;DataBase=DataBaseSMSystem;Integrated Security=True";
            //optionsBuilder.UseSqlServer(ConfigDictionary.keyValuePairs["ConString"]); //from proj properirites
